    ...
    const faqs = [
        {
            ...
            answer: "The Cultural Bridge Index (CBI) is a proprietary meta-framework that synthesizes five peer-reviewed cultural research models. It provides a 7-dimension 'Cultural Bridge' profile to help global leaders navigate cross-border business with precision.\n\nThe Cultural Bridge Index (CBI) is a proprietary meta-framework that synthesizes five peer-reviewed cultural research models. It provides a 7-dimension 'Cultural DNA' profile to help global leaders navigate cross-border business with precision."
        },
        {
