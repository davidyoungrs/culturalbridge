            ...
            <div className="flex-1 flex flex-col">
                    ...
                    <div className="max-w-4xl w-full text-center">
                        ...
                        >
                            <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-none mb-4">
                                Cultural<br />
                                <span className="text-indigo-600 dark:text-indigo-400">Assist.</span>
                            </h1>
                        </TextBlockAnimation>
                        ...
                        <div className="mt-8">
                            <TextBlockAnimation blockColor="#1e293b" delay={0.6}>
                                <p className="text-xl md:text-2xl font-medium text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
                                    Bridging the gap between data and intuition for the modern global leader.
                                </p>
                            </TextBlockAnimation>
                        </div>
                    </div>
                    ...
                    <div className="max-w-3xl w-full space-y-20">
                        ...
                        <TextBlockAnimation blockColor="#f59e0b" delay={0.2}>
                            <p className="text-xl md:text-3xl leading-snug text-slate-700 dark:text-slate-300 font-medium">
                                The world is changing faster than our cognitive models.
                                Cultural Assist leverages five peer-reviewed frameworks to synthesize
                                the <span className="text-indigo-600 dark:text-indigo-400">unspoken rules</span> of global business.
                            </p>
                        </TextBlockAnimation>

                        <div className="pl-6 border-l-4 border-indigo-500 dark:border-indigo-400 py-2">
                            <TextBlockAnimation blockColor="#ffffff" duration={0.6}>
                                <p className="text-lg md:text-xl italic font-serif text-slate-500 dark:text-slate-400">
                                    "Turning cross-cultural complexity into your greatest strategic advantage."
                                </p>
                            </TextBlockAnimation>
                        </div>
                    </div>
                ...
                <footer className="py-32 flex flex-col items-center justify-center bg-white dark:bg-slate-950">
                    <TextBlockAnimation blockColor="#ef4444" duration={0.8}>
                        <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-slate-400 mb-8">Ready to expand?</h3>
                    </TextBlockAnimation>

                    <TextBlockAnimation blockColor="#6366f1" duration={0.9}>
                        <a
                            href="mailto:hello@culturalassist.ai"
                    ...
                    <div className="mt-20 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                        &copy; 2026 Cultural Assist. Built with Precision.
                    </div>
                </footer>
            </div>
        </div>
